...
struct MonthlyWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = MonthlyWidgetAttributes(name: "Me")
    static let contentState = MonthlyWidgetAttributes.ContentState(value: 3)
